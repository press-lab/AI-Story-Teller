...
export function createDefaultAdventure(title = "Untitled Adventure"): Adventure {
  ...
  return {
    ...
    components: [
      ...
      makeComponent({ title: "Active Pressure", type: "activePressure", content: "", priority: 245, active: true, autoUpdateCooldownTurns: 8 }),
      makeComponent({ title: "Immediate Momentum", type: "immediateMomentum", content: "", priority: 240, active: true, autoUpdateCooldownTurns: 3 }),
    ],
    storyCards: [],
    brains: [],
    triggerRules: [],
